...
static struct gpiomux_setting ipq806x_pwr_led_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct gpiomux_setting gpio10_mdio = {
	.func = GPIOMUX_FUNC_GPIO,	/* MDIO: GPIOMUX_FUNC_5 */
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
static struct gpiomux_setting gpio11_mdc = {
	.func = GPIOMUX_FUNC_GPIO,	/* MDC: GPIOMUX_FUNC_6 */
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
static struct gpiomux_setting gpio0_mdio = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
static struct gpiomux_setting gpio1_mdc = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting phy_intr = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_16MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting gpio_input = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting uart_tx_rx = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_10MA,
	.pull = GPIOMUX_PULL_DOWN,
};
...
static struct msm_gpiomux_config ipq806x_ap148_gpiomux[] = {
...
#if defined(BRTAC828_SR1)
	/* BRT-AC828 SR1 */
	ipq_mux( 2 , nss_gmac0_rgmii_set1,		nss_gmac0_rgmii_set1),	/* DRV STR for RGMII0 RX */
	ipq_mux( 66, nss_gmac0_rgmii_set1,		nss_gmac0_rgmii_set1),	/* DRV STR for RGMII0 TX */

	ipq_mux( 3, pcie_rst_n,				pcie_rst_n),		/* PCIe 1 */
	ipq_mux(48, pcie_rst_n,				pcie_rst_n),		/* PCIe 2 */

	/* LEDs */
	ipq_mux( 7, ipq806x_leds_cfg,			ipq806x_leds_cfg),	/* LED_USB1 */
	ipq_mux( 8, ipq806x_leds_cfg,			ipq806x_leds_cfg),	/* LED_USB3 */
	ipq_mux(53, ipq806x_leds_cfg,			ipq806x_leds_cfg),	/* STATUS_LED_PASS */
	ipq_mux(67, ipq806x_leds_cfg,			ipq806x_leds_cfg),	/* LED_5G */
	ipq_mux(68, ipq806x_leds_cfg,			ipq806x_leds_cfg),	/* LED_2G */

	/* buttons */
	ipq_mux(54, gpio_input,				gpio_input),		/* RESET_BT */

	ipq_mux( 2, rtk_switch_intr,			rtk_switch_intr),
	ipq_mux( 6, phy_intr,				phy_intr),		/* PHY4 interrupt */
	ipq_mux( 9, phy_intr,				phy_intr),		/* PHY5 interrupt */

	/* RTL8370M-GR MDC/MDIO */
	ipq_mux( 0, gpio0_mdio,				gpio0_mdio),
	ipq_mux( 1, gpio1_mdc,				gpio1_mdc),

	/* QCA8033 PHYs MDC/MDIO */
	ipq_mux(10, gpio10_mdio,			gpio10_mdio),
	ipq_mux(11, gpio11_mdc,				gpio11_mdc),

	ipq_mux(12, gsbi4_active_cfg,			gsbi4_suspended_cfg),	/* I2C SDA */
	ipq_mux(13, gsbi4_active_cfg,			gsbi4_suspended_cfg),	/* I2C SDL */

	ipq_mux(14, gpio_input,				gpio_input),
	ipq_mux(15, gpio_input,				gpio_input),
	ipq_mux(16, gpio_input,				gpio_input),
	ipq_mux(17, gpio_input,				gpio_input),
	...
	ipq_mux(22, uart_tx_rx,				uart_tx_rx),
	ipq_mux(23, uart_tx_rx,				uart_tx_rx),

	ipq_mux(24, gpio_input,				gpio_input),		/* SSD_DT */
	ipq_mux(25, gpio_input,				gpio_input),		/* SSD_PWR_EN */
	ipq_mux(64, gpio_input,				gpio_input),		/* SD_WP_IO, TP8 */
	ipq_mux(65, gpio_input,				gpio_input),		/* SD_CD_IO */

	ipq_mux(26, gpio_input,				gpio_input),		/* TP20 */
	ipq_mux(55, gpio_input,				gpio_input),		/* TP4 */
	ipq_mux(56, gpio_input,				gpio_input),		/* TP5 */
	ipq_mux(57, gpio_input,				gpio_input),		/* TP6 */
	ipq_mux(58, gpio_input,				gpio_input),		/* TP7 */
	...
	ipq_mux(33, gpio_input,				gpio_input),		/* BOOT_CONFIG4 */

	ipq_mux(63, reset_control,			reset_control),		/* SW_RESET */
#else
	...
	ipq_mux( 3, pcie_rst_n,			pcie_rst_n),		/* PCIe 1 */
	ipq_mux(48, pcie_rst_n,			pcie_rst_n),		/* PCIe 2 */
	ipq_mux(63, pcie_rst_n,			pcie_rst_n),		/* PCIe 3 */

	/* LEDs */
	ipq_mux( 6, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_WAN2 */
	ipq_mux( 7, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_USB1 */
	ipq_mux( 9, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_WAN */
	ipq_mux(15, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_USB3 */
#if !defined(BRTAC828_SR2)
	ipq_mux(25, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* SATA_LED */
#else
	ipq_mux(25, gpio_input,			gpio_input),		/* TP3 */
#endif
	ipq_mux(26, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* FAIL_OVER_LED */
	ipq_mux(53, ipq806x_pwr_led_cfg,	ipq806x_pwr_led_cfg),	/* STATUS_LED_PASS, PWR LED */
	ipq_mux(55, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* WAN_RED_LED */
	ipq_mux(56, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* WAN1_RED_LED */
	ipq_mux(57, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* STATUS_RLED_PASS, PWR RED LED */
	ipq_mux(67, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_5G */
	ipq_mux(68, ipq806x_leds_cfg,		ipq806x_leds_cfg),	/* LED_2G */

	/* buttons */
	ipq_mux(16, gpio_input,			gpio_input),		/* WPS_BTN */
	ipq_mux(17, gpio_input,			gpio_input),		/* USB_BTN */
	ipq_mux(24, gpio_input,			gpio_input),		/* USB3_BTN */
	ipq_mux(54, gpio_input,			gpio_input),		/* RESET_BT */
	...
	/* GMAC2 SGMII0; 1.8V RGMII is not used. */
	ipq_mux(27, gpio_input,			gpio_input),
	ipq_mux(28, gpio_input,			gpio_input),
	ipq_mux(29, gpio_input,			gpio_input),
	ipq_mux(30, gpio_input,			gpio_input),
	ipq_mux(31, gpio_input,			gpio_input),
	ipq_mux(32, gpio_input,			gpio_input),
	ipq_mux(51, gpio_input,			gpio_input),
	ipq_mux(52, gpio_input,			gpio_input),
	ipq_mux(59, gpio_input,			gpio_input),
	ipq_mux(60, gpio_input,			gpio_input),
	ipq_mux(61, gpio_input,			gpio_input),
	ipq_mux(62, gpio_input,			gpio_input),
#endif

	ipq_mux(33, gpio_input,			gpio_input),		/* BOOT_CONFIG4 */

	ipq_mux(58, reset_control,		reset_control),		/* SW_RESET */
#endif
...
#else
#error Define your own GPIO table
#endif
};
