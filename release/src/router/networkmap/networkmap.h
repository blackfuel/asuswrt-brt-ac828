...
/* FIXME:
 * Unify CLIENT_DETAIL_INFO_TABLE definition in below files:
 * src/router/networkmap/networkmap.h
 * src/router/libnmp/nmp.h
 * src/router/shared/networkmap.h
 * src/router/miniupnpc/upnpc.c
 */
typedef struct {
	...
	char		pad[2];
        int             type[MAX_NR_CLIENT_LIST];
        int             http[MAX_NR_CLIENT_LIST];
        int             printer[MAX_NR_CLIENT_LIST];
        int             itune[MAX_NR_CLIENT_LIST];
	int		exist[MAX_NR_CLIENT_LIST];
