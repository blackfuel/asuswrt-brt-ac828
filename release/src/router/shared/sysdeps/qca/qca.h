...
#define OFFSET_DEF_GROUPID		(MTD_FACTORY_BASE_ADDRESS + FTRY_PARM_SHIFT + 0x0D1B0)	// CFGSYNC_GROUPID_LEN (32 bytes)
#endif

#if defined(MAPAC1300) || defined(MAPAC2200) || defined(VZWAC1300) || defined(RTAC92U) || defined(MAPAC2200V) || defined(VRZAC1300) /* for Lyra */
...
#elif defined(RTAC92U)
#define BD_2G_PREFIX	"boardData_1_0_IPQ4019_DK04_2G"
#define BD_5G_PREFIX	"boardData_1_0_IPQ4019_DK04_5G"
#define BD_5G2_PREFIX	"boardData_QCA9984_CUS239_high_band_5G_v1_20181121"
#define BD_2G_CHIP_DIR	"IPQ4019"
#define BD_2G_HW_DIR	"hw.1"
#define BD_5G_CHIP_DIR	"IPQ4019"
#define BD_5G_HW_DIR	"hw.1"
