...
#endif
#else
	{ "wl_bw",			"1"	},	/* 0/1/2/3/4/5 20/auto/40/80/80+80/160MHz */
#endif
...
//#ifdef RTCONFIG_SWITCH_CONTROL_8367
	...
	{ "wans_lb_ratio", "1:1" }, 	// only support two wan simultaneously
#else
...
#if defined(RTCONFIG_BWDPI) || defined(RTCONFIG_BWDPI_DEP)
	// TrendMicro module
	{ "wrs_protect_enable", "0"},           // AiProtection v2.0 total switch
	{ "wrs_mals_enable", "1" },             // mals switch
	{ "wrs_cc_enable", "1" },               // cc   switch
	{ "wrs_vp_enable", "1" },               // vp   switch
	{ "wrs_enable", "0" },                  // web content filter
	{ "wrs_rulelist", "" },                 // <switch1>MAC1>Adult1>...<switch2>MAC2>Adult2>...
	{ "wrs_app_enable", "0" },              // app patrol
	{ "wrs_app_rulelist", "" },             // <switch1>MAC1>Commercial1>...<switch2>MAC2>Commercial2>...
	{ "wrs_mail_bit", "7" },                // alert mail option, default enable : MALS + VP + CC
	{ "wrs_mals_t", "0" },		        // mals timestamp for query
	{ "wrs_cc_t", "0" },		        // cc   timestamp for query
	{ "wrs_vp_t", "0" },		        // vp   timestamp for query
	{ "bwdpi_db_enable", "0" },             // traffic analyzer switch
...
//#endif
	...
	{"cp_backup", "127.0.0.1"},
	{"cp_radiusport", "1812"},
	{"cp_radiusauthport", "1812"},
	{"cp_radiusnasid", "radius"},
	{"cp_dns1", "8.8.8.8"},
	{"cp_uamsecret", "chillispot"},
	{"cp_radiussecret", "radius"},
	{"cp_uamanydns", "0"},
	{"cp_uamallowed", ""},
	{"cp_nowifibridge", "1"},	
	{"cp_net", "192.168.183.0/24"},
	{"cp_macauth", "0"},
	{"cp_macpasswd", "password"},
	{"cp_802.1Xauth", "0"},
	{"cp_additional", ""},
	{"cp_protocol", "http"},
	{"cp_authport", "http"},
...
/*	{ "http_lanport", "80"}, */
	...
	{ "captive_portal_adv_idle_timeout",		"300" },
