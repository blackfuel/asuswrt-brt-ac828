		...
		<table width="740px"  height="35" cellpadding="2" cellspacing="0" class="accountBar">
			<tr>
				...
				<td width="25%" style="border: 1px solid #222;">
					<table align="right">
						<tr>
							<td style="display:none"><div id="createAccountBtn" title="<#AddAccountTitle#>"></div></td>
							<td style="display:none"><div id="deleteAccountBtn" title="<#DelAccountTitle#>"></div></td>
							<td style="display:none"><div id="modifyAccountBtn" title="<#ModAccountTitle#>"></div></td>
							<td>
