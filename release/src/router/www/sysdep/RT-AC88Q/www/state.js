...
function isSupport(_ptn){
	if(_ptn == "rog"){
		...
		if((based_modelid == "RT-AC3200" || based_modelid == "RT-AC87U" || based_modelid == "RT-AC88U"|| based_modelid == "RT-AC3100" || 
			based_modelid == "RT-AC5300" || based_modelid == "RT-AC5300R" || based_modelid == "DSL-AC68U" || based_modelid == "RT-AC68U" || 
			based_modelid == "RT-AC68R" || based_modelid == "RT-AC68W" || based_modelid == "RT-AC68RW" || based_modelid == "RT-AC1900P" || 
...
var goToPage = function(menu, tab, obj){
	cookie.set("clickedItem_menu", menu);
...
function showMenuTree(menuList, menuExclude){
	...
	var getCode = function(flag){
		...
		var getTabCode = function(){
			...
			if(menuList[clickedItem.menu].tab[clickedItem.tab].tabName !== "__HIDE__" && tabCounter > 1){
				tab_container += '<div style="margin-top:40px"><table>';
	...
	// index.asp
		...
		if(usbPortMax == 3)	tableHeight = 1100;
		if(tableHeight < 825) tableHeight = 825;
		document.getElementById("NM_table").style.height = (tableHeight - 25) + "px";
	}
}
...
*/
function checkIPConflict(CompareItem, sourceIP, sourceMask)
{
	//create Constructor
