...
function add_account(flag, target){
	...
	// validate form
	if(info.account.length >= 200){
		alert("The number of accounts reaches the limitiation.");
		return false;
	}
								...
								<td bgcolor="#4D595D" valign="top">
									...
									<div>
										<div style="display:flex">
											...
											<div style="font-weight:900;padding-left:10px;line-height:34px;">(<#List_limit#> 200 units)</div>
										</div>									
