...
function applyRule(){
	...
	if(reset_wan_and_nat(document.form, document.form.wrs_mals_enable.value) &&
		reset_wan_and_nat(document.form, document.form.wrs_vp_enable.value) &&
		reset_wan_and_nat(document.form, document.form.wrs_cc_enable.value)) {
		showLoading();
