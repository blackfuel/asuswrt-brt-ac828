...
<div id="edit_ipsec_profile_panel" class="ipsec_profile_panel" style="padding:15px;">
	...
	<table id="tbAccountList" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table" style="margin-top:15px;">
		...
		<tr>
			<td width="45%">
				<input type="text" class="input_25_table" maxlength="64" name="ipsec_client_list_username" onKeyPress="return validator.isString(this, event)">
			</td>
			<td width="45%">
				<input type="text" class="input_25_table" maxlength="64" name="ipsec_client_list_password" onKeyPress="return validator.isString(this, event)">
			</td>
			<td width="10%">
